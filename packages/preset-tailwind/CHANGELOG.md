...
* Add missing height properties max/min/fit-content ([#285](https://github.com/tw-in-js/twind/pull/285)) 🙏🏽 [@IgnusG](https://github.com/IgnusG)!
...
- fix: default border color in preflight ([`f7650fe8`](https://github.com/tw-in-js/twind/commit/f7650fe81f20e4f711f7766b5886cb72e0af67d2))
...
* attribute selector as modifier for groups and peers ([`2c823293`](https://github.com/tw-in-js/twind/commit/2c82329376ef3f743bc25f355468f4a45c36a3e6))
...
* ensure group and peer marker classes are hashed ([`4fa0d3f0`](https://github.com/tw-in-js/twind/commit/4fa0d3f04d992d4f81986683466c5f60964b783d))
...
* enhance typing of defaultTheme ([#244](https://github.com/tw-in-js/twind/pull/244))
...
- BREAKING: colors are now named exports; this allows tree-shaking unused colors ([#241](https://github.com/tw-in-js/twind/pull/241))
